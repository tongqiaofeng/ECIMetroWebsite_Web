<template>
  ...
  <div v-if="cliWidth > 768" class="eci-main-content">
    ...
    <div>
      <div class="home-title-six"><div>动力设备</div></div>
    ...
    <div class="classify-main" v-if="childList">
      <div v-for="item in childList" :key="item.id" class="classify-every">
        <router-link
          v-if="item.equipmentTypeName == '电力设备'"
          to="/product/power/electricity"
        >
          <img
            class="classify-img"
...
const { grabContent, imgClassifyUrl, imgClassifyPhoneUrl, childList } =
  await getProductClassify("动力设备");
console.log("6---------------------------", childList.value);
</script>

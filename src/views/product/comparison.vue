    ...
    <div class="comparision-product">
      ...
      <div class="every" @click="showPicker = true">
        <div v-if="productComparisonInfo">
          <div class="every-content">
            <img
              v-if="productComparisonInfo.imgUrl"
              :src="
                base_request_url +
                '/file/' +
      ...
      <van-collapse v-model="activeNames">
          ...
          <div class="engine-params">
            <div class="params-every" v-if="isShowParams('engineModel')">
              <div
                ...
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
              >
                发动机型号
              </div>
              <div
                class="params"
                :style="{ color: showAll == 0 ? '#4D4D4D' : '#E6AC00' }"
              >
        ...
        >
          <div class="engine-params">
            <div
              class="params-every"
              v-if="isShowParams('rotaryMachinerySpeed')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('rotaryMachineryMaxTorque')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
        ...
        >
          <div class="engine-params">
            <div
              class="params-every"
              v-if="isShowParams('hydraulicArmCylinderBore')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicArmCylinderStroke')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicBoomCylinderBore')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicBoomCylinderStroke')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicBucketCylinderBore')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicBucketCylinderStroke')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicEquipmentMaxPressure')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicMaxSystemFlow')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicRotationMaxPressure')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('hydraulicSteerMaxPressure')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
        ...
        >
          <div class="engine-params">
            ...
            <div
              class="params-every"
              v-if="isShowParams('trackThrustWheelNum')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('trackCarrierSprocketNum')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
        ...
        >
          <div class="engine-params">
            ...
            <div
              class="params-every"
              v-if="isShowParams('capacityRotationDrive')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('capacityHydraulicSystem')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
            ...
            <div
              class="params-every"
              v-if="isShowParams('capacityHydraulicTank')"
            >
              <div
                class="params parameter"
                :style="{ color: showAll == 0 ? '#1a1a1a' : '#E6AC00' }"
  ...
  >
    <div class="product-popup">
      ...
      <div class="popup-main">
        <div
          class="product-every"
          v-for="item in compariProductList"
          :key="item.id"
          @click="selProductSure(item)"
        >
          <div class="every-img">
            <img
          ...
          <div class="every-main">
            ...
            <div class="line"></div>
            <div class="params">铲斗容量：{{ item.bucketCapacity + "m³" }}</div>
